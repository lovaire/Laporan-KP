...
Dari sisi teknis, pelaksana memperoleh pemahaman yang lebih mendalam mengenai pengembangan \textit{backend} aplikasi web menggunakan \textit{framework} Django, pengolahan data \textit{fingerprint} dalam format XLS, serta implementasi fitur dashboard statistik. Sistem yang dibangun berhasil diimplementasikan secara \textit{live} dan terbukti membantu pihak sekolah dalam mengelola data kehadiran dan perizinan guru secara lebih efisien.
