...
%
% Judul laporan.
\def\judul{Pengembangan Dashboard Absensi Guru dan Perizinan Pondok Modern Al-Ghozali}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
\def\judulInggris{Development of a Teacher Attendance and Leave Management Dashboard at Pondok Modern Al-Ghozali}
...
\def\penulisSatu{Rifqi Rahmatuloh} % nama lengkap penulis pertama
...
\def\npmSatu{2206820365} % NPM penulis pertama
...
\def\pembimbingSatu{Ichlasul Affan, S.Kom., M.Kom.}
...
\Var{\babDua}{Isi}
\Var{\babTiga}{Penutup}
\Var{\daftarReferensi}{Daftar Referensi}
